...
<?php
  ...
  if(isset($_GET['check_item_id'])){
    ...
    if(isset($_POST['order_submit'])){
      ...
      $con_numb = mysqli_real_escape_string($conn, strip_tags($_POST['contact']));
      $state = mysqli_real_escape_string($conn, strip_tags($_POST['state']));
      $delivery_adress = mysqli_real_escape_string($conn, strip_tags($_POST['delivery_adress']));
            ...
            <div class="modal-body">
              <form method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea name="adress" name="delivery_adress" id="" cols="30" rows="10" class="form-control"></textarea>
                </div>
                <div class="form-group">
