            ...
            <div class="modal-body">
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input name = "item_qty" type="number"  class = "form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name = "item_discount" type="number"  class = "form-control">
                </div>
                <div class="form-group">
                  <label for="">Item delivery charge</label>
                  <input name = "item_delivery" type="number"  class = "form-control">
                </div>
                <div class="form-group">
                  <input name = "item_submit" type="submit"  class = "btn btn-primary btn-block">
                </div>
              </form>
            </div>
